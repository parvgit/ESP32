...
const char* ssid = "xxxxx";  //Replace with your network ID
const char* password = "yyyyyyyyyyyy";  // Replace with your network password
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Parveen Wifi Server on Local Network</h1>");
            ...
            client.println("<p>GPIO 4 - Currently" + output0State + "</p>");
            ...
            client.println("<p> This code is added by Parven Kumar </p>");
